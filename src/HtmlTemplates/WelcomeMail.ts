                                          ...
                                          <tr>
                                            <td class="es-infoblock esd-block-text es-m-txt-c" align="left">
                                              <p style="font-family: arial, helvetica\neue, helvetica, sans-serif">
                                                Welcome to Digital-Q Talent platform
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                    ...
                    <td class="esd-stripe" esd-custom-block-id="7388" align="center">
                      ...
                      >
                        <tbody>
                          <tr>
                            <td
                              class="esd-structure esd-checked es-p40t es-p40b es-p40r es-p40l"
                              style="
                                background-image: url(&quot;https://tlr.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/93491522393929597.png&quot;);
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td
                                              ...
                                              class="esd-block-text es-p10t es-p20b es-p30r es-p30l"
                                              align="center"
                                            >
                                    ...
                                    <td class="esd-container-frame" width="520" valign="top" align="center">
                                      <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="esd-block-text es-p10t es-p10b" align="left">
                                              <p style="padding: 0px; margin-bottom: 0%">Yours sincerely,</p>
                                            </td>
                                          </tr>
                                          <tr>
                    ...
                    <td class="esd-stripe" esd-custom-block-id="7392" align="center">
                      ...
                      >
                        <tbody>
                          <tr>
                            <td
                              class="esd-structure es-p40t es-p20b es-p40r es-p40l"
                              style="background-color: #26a4d3"
                              bgcolor="#26a4d3"
                              align="left"
                            >
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="esd-block-text es-p5t es-p10b" align="center">
                                              <p style="color: #aad4ea; font-size: 17px">
                            ...
                            <td class="esd-structure es-p30t es-p30b es-p40r es-p40l" align="left">
                              <table width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                  <tr>
                                    <td class="esd-container-frame" width="520" valign="top" align="center">
                                      <table width="100%" cellspacing="0" cellpadding="0" height="40px">
                                        <tbody>
                                          <tr>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td valign="top" align="center">
                                                      <a target="_blank" href>
                                                        <img
                                                          title="Linkedin"
                                                          src="https://tlr.stripocdn.email/content/assets/img/social-icons/circle-white/linkedin-circle-white.png"
                                                          alt="In"
                                                          width="24"
                                                          height="24"
                                                        />
